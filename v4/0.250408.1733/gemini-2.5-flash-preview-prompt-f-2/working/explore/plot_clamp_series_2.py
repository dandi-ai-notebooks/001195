# This script loads and plots the fifth current clamp response and stimulus.
...
# Get data
response = nwb.acquisition["current_clamp-response-05-ch-0"]
stimulus = nwb.stimulus["stimulus-05-ch-0"]
...
plt.tight_layout()
plt.savefig('explore/current_clamp_series_05_ch_0.png')
